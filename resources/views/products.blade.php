        ...
        <div class="row">
            <div class="col-lg-3 order-2 order-lg-1">
                <div class="filter-widget">
                            <h2 class="fw-title">Платья</h2>
                    <ul class="category-menu">
                       {{-- <li>

                            <a href="{{route('/products')}}">Женская одежда</a>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="{{route('/productsByCategory', $category->id)}}">{{$category -> name}}<span>(2)</span></a>
                                </li>
                                    @endforeach
                                @endif
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="product-item">
                            <div class="pi-pic">
                                ...
                                <img src="{{ Storage::url($product->img_1) }}" alt="">
                                <div class="pi-links">
                                    <a href="{{route('/product',['id'=> $product->id])}}" class="add-card"><i class="flaticon-bag"></i><span>В КОРОЗИНУ</span></a>
