...
{{--						<h4>корзина товаров</h4>--}}
						<div class="cart-table-warp">
							...
							<thead>
								<tr>
									...
									<th class="quy-th">Удалить</th>
									<th class="size-th">Розмер</th>
							...
							<tbody>
								...
								<tr>
									<td class="product-col">
										<img src="storage/{!!$item ->attributes-> img_1 !!}" alt="">
										<div class="pc-title">
											<h4>₴&nbsp;{{$item->name}}</h4>
											<p></p>
										</div>
									...
									<td class="quy-col">
                                       ...
                                       {{-- <form action="{{ route('/remove-itemcart' }}"
                                              method="post" class="d-inline">
                                            @csrf
                                            <input type="image" name="image" src="img/icons/32.png" >
                                        </form>--}}


                                         <div class="feature-icon">

                                            {{-- <form method="post" action="{{route('/remove-itemcart/'.$item->id )}} ">
                                                 @csrf
                                                 <input type="image" name="image" src="img/icons/32.png"/>
                                             </form>--}}
                                             ...
                                             <a href="{{url('/remove-itemcart/'.$item->id)}}"><img src="img/icons/32.png" alt="#"></a>
                                         </div>
				...
				<div class="col-lg-4 card-right">
					...
					<a href="/checkout" class="site-btn">Оформить заказ</a>
